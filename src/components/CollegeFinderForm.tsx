  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
      <div className="max-w-4xl mx-auto p-4 sm:p-6 md:p-8">
        ...
        {/* Progress Section - Hidden for first step */}
        {currentStep > 0 && (
          <div className="mb-8 sm:mb-12">
            <div className="flex justify-between items-center mb-3 sm:mb-4">
              <div className="flex items-center gap-2 sm:gap-3">
                <span className="text-base sm:text-lg font-bold text-foreground">Step {currentStep}</span>
                <span className="text-sm text-muted-foreground">of {totalSteps - 1}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-xs sm:text-sm text-muted-foreground">Progress:</span>
                <span className="text-sm sm:text-lg font-bold text-accent">{Math.round((currentStep / (totalSteps - 1)) * 100)}%</span>
              </div>
            </div>
        ...
        <div className="relative">
          <Card className={`shadow-2xl border-0 mb-6 sm:mb-8 bg-white dark:bg-gray-900 rounded-3xl overflow-hidden ${
            currentStep === 0 
              ? 'p-4 sm:p-6 md:p-8 min-h-[60vh] sm:min-h-[70vh] flex items-center' 
            ...
            <div className={`relative z-10 ${currentStep === 0 ? 'w-full' : ''}`}>
              <FormStep
                step={currentStep}
                formData={formData}
        ...
        {/* Enhanced Navigation - Hidden for first step */}
        {currentStep > 0 && (
